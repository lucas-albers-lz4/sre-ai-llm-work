...
_Generated 2026-07-03 (UTC) by `scripts/generate_dashboard.py`._
...
|---|---|---|---|---|
| `guide/00-principles.md` | 8/30 | 2026-02-12 (`paper-gloaguen-agentsmd-effectiveness`) | 83% | 293 (n/a) |
| `guide/01-daily-workflows.md` | 12/30 | 2026-03-09 (`discussion-hn-agentic-coding-jobs`) | 36% | 715 (n/a) |
| `guide/02-harness-engineering.md` | 20/30 | 2025-09-17 (`failure-claudemd-ignored-compaction`) | 44% | 1526 (n/a) |
| `guide/03-verification.md` | 22/30 | 2025-09-17 (`failure-claudemd-ignored-compaction`) | 40% | 1030 (n/a) |
| `guide/04-context-engineering.md` | 14/30 | 2025-12-27 (`blog-sankalp-claude-code-20`) | 0% | 1240 (n/a) |
| `guide/05-team-adoption.md` | 20/30 | 2025-11-06 (`paper-miller-speed-cost-quality`) | 5% | 1552 (n/a) |
