...
- `big-pickle`: **validated live alternate** (#606 / PR #611 APPROVE); distinct
  model id; peak cron default remains Flash-free (manual failover only).
