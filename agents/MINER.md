...
If the workflow provides a related-notes candidates file
(`miner-related-notes.md` at the repo root, or
...
never invent corroboration to “use” a candidate. Do not commit the
candidates file. An empty candidate list is a legitimate “none found”
signal; you may still discover additional cross-refs by searching
`source-notes/` yourself. Verification in §4b still applies to every
citation you write.
