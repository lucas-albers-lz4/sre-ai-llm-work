...
| `smith-on-source-merge.yml` | Smith | `push` to `main` affecting `source-notes/**.md` | Opus | Diff-aware synthesis. Opens a fresh `smith/source-merge-<run_id>` branch + `guide-update` PR if any chapter material changes |
